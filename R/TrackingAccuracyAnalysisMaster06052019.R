...
setwd("~/Documents/DREAMpaper/MasterData")
trackingResults=read.csv("clean_curated_cell_data.csv")
...
setwd("~/Documents/DREAMpaper/MasterData/RefinedCentroidCell_data")
refinedfeaturesABCS47iTDPSurvival=read.csv("AB-CS47iTDP-Survival_refinedcentroid_cell_data.csv")
refinedfeaturesABCS47iTDPSurvival$Experiment="AB-CS47iTDP-Survival"
refinedfeaturesABSOD1KW4WTC11=read.csv("AB-SOD1-KW4-WTC11-Survivalcentroidrefinedcell_data.csv")
refinedfeaturesABSOD1KW4WTC11$Experiment="AB-SOD1-KW4-WTC11-Survival"
refinedfeaturesAB7SOD1KW4WTC11Survivalexp3=read.csv("AB7-SOD1-KW4-WTC11-Survival-exp3_refinedcentroid_cell_data.csv")
refinedfeaturesAB7SOD1KW4WTC11Survivalexp3$Experiment="AB7-SOD1-KW4-WTC11-Survival-exp3"
refinedfeaturesKSABiMNTDP43Survival=read.csv("KS-AB-iMN-TDP43-Survivalcentroidrefinedcell_data.csv")
refinedfeaturesKSABiMNTDP43Survival$Experiment="KS-AB-iMN-TDP43-Survival"
refinedfeaturesLINCS062016A=read.csv("LINCS062016A_refinedcentroid_cell_data.csv")
refinedfeaturesLINCS062016A$Experiment="LINCS062016A"
refinedfeaturesLINCS062016B=read.csv("LINCS062016Brefinedcentroidcell_data_deduplicated.csv")
refinedfeaturesLINCS062016B$Experiment="LINCS062016B"
refinedfeaturesLINCS062016B$ElapsedHours=NULL
refinedfeaturesLINCS092016A=read.csv("LINCS092016Arefinedcentroidcell_data.csv")
refinedfeaturesLINCS092016A$Experiment="LINCS092016A"
refinedfeaturesLINCS092016B=read.csv("LINCS092016Brefinedcentroidcell_data.csv")
...
setwd("~/Documents/DREAMpaper/MasterData/HarmonizedMaster")
write.csv(MergeFeaturesManualCuration, "ManualCurationFeatures.csv")
...
setwd("~/Documents/DREAMpaper/MasterData/SurvivalData")

HRsurv1=read.csv("Survival-AB47iTDP_combined_wproximity.csv")
HRsurv1$MeasurementTag=NULL
HRsurv1$Experiment="AB-CS47iTDP-Survival"
HRsurv2=read.csv("AB-SOD1_survival_combined_wproximity.csv")
HRsurv2$Experiment="AB-SOD1-KW4-WTC11-Survival"
HRsurv3=read.csv("AB7-SOD1-KW4-WTC11-Survival-exp3_combined_wproximity.csv")
HRsurv3$Experiment="AB7-SOD1-KW4-WTC11-Survival-exp3"
HRsurv4=read.csv("KS-AB-iMN_survival_combined_wproximity.csv")
HRsurv4$Experiment="KS-AB-iMN-TDP43-Survival"
HRsurv5=read.csv("LINCS062016A_survival_combined_wproximity.csv")
HRsurv5$Experiment="LINCS062016A"
HRsurv6=read.csv("LINCS092016B_survival_combined_wproximity.csv")
HRsurv6$Experiment="LINCS062016B"
HRsurv7=read.csv("survival_LINCS092016A_combined_wproximity.csv")
HRsurv7$Experiment="LINCS092016A"
HRsurv8=read.csv("Survival-LINCS062016B_combined_wproximity.csv")
...
setwd("~/Documents/DREAMpaper/MasterData/HarmonizedMaster")
write.csv(HRsurvMerge4, "CombinedSurvivalComparison.csv")
...
write.csv(MergeFeaturesManualCuration2, "CombinedSurvivalandFeatures.csv")
...
setwd("~/Documents/DREAMpaper/MasterData/VeronoitrackingData")

surv1= read.csv("AB7-SOD1-KW4-WTC11-exp3-integrated_tracking.csv")
...
surv2=read.csv("cell_data_AB-SOD1_youngstrack.csv")
...
surv3=read.csv("cell_data_KS-AB-iMN_youngstrack.csv")
...
surv4=read.csv("cell_data_LINCS062016A_youngstrack.csv")
...
surv5=read.csv("cell_data_LINCS092016A_youngstrack.csv")
...
surv6=read.csv("Cell_data_LINCS092016B_youngstrack.csv")
...
surv7=read.csv("cell-data-AB-CS47iTDP-youngstrack.csv")
...
surv8=read.csv("LINCS062016B-integrated_tracking.csv")
...
setwd("~/Documents/DREAMpaper/MasterData/HarmonizedMaster")
write.csv(masterYoungTracksShortOutput, "RawVeronoitrackingData.csv")
...
setwd("~/Documents/DREAMpaper/MasterData/OverlaptrackingData")
OLsurv1=read.csv("cell_data_KS-AB-iMN-TDP43-Survival.csv")

OLsurv2=read.csv("cell_data-AB-CS47iTDP.csv")

OLsurv3=read.csv("cell_data-AB-SOD1-KW4-WTC11.csv")

OLsurv4=read.csv("cell_data-AB7-SOD1-KW4-WTC11-exp3.csv")

OLsurv5=read.csv("HCA_DATA_LINCS062016B.csv")
##Make PP adjustments
...
OLsurv6=read.csv("LINCS062016APROXIMITYREPEAT_cell_data.csv")
...
OLsurv7=read.csv("LINCS092016APROXIMITYREPEAT_cell_data.csv")
...
OLsurv8=read.csv("LINCS092016BPROXIMITYREPEAT_cell_data.csv")
...
setwd("~/Documents/DREAMpaper/MasterData/HarmonizedMaster")
write.csv(masterOLsurvShortOutput, "RawOverlapTrackingData.csv")
...
setwd("~/Documents/DREAMpaper/TrackingAccuracy/ProximityTracking")
Prsurv1=read.csv("AB-CS47iTDP-SurvivalPROXIMITYREPEATcell_data.csv", stringsAsFactors = FALSE)
...
Prsurv2=read.csv("AB-SOD1-KW4-WTC11-SurvivalPROXIMITYREPEATcell_data.csv", stringsAsFactors = FALSE)
...
Prsurv3=read.csv("AB7-SOD1-KW4-WTC11-Survival-exp3PROXIMITYREPEATcell_data.csv", stringsAsFactors = FALSE)
...
Prsurv4=read.csv("cell_data_Galaxy_LINCS062016A.csv", stringsAsFactors = FALSE)

Prsurv5=read.csv("cell_data_LINCS092016A.csv", stringsAsFactors = FALSE)

Prsurv6=read.csv("cell_data_LINCS092016B.csv", stringsAsFactors = FALSE)

Prsurv7=read.csv("KS-AB-iMN-TDP43-SurvivalPROXIMITYREPEAT_cell_data.csv", stringsAsFactors = FALSE)
...
Prsurv8=read.csv("ProximityLINCS062016Bcell_data.csv", stringsAsFactors = FALSE)
...
setwd("~/Documents/DREAMpaper/MasterData/HarmonizedMaster")
write.csv(masterPrsurvShortOutput, "RawProximityTrackingData.csv")
...
write.csv(ALLPERWELLTRACKING, "ALLPERWELLTRACKINGDataDEATHFILTER.csv")
